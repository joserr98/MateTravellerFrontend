    ...
    <div className='homeDesign'>
      <div className='homeContainer'>
        ...
        <div className='homeSection'>
          <p>Introducing MateTraveler, the innovative web application designed to connect solo travelers
          ...
          MateTraveler provides a platform where you can meet fellow travelers and forge meaningful connections along the way.</p> 
          ...
          <p>Say goodbye to lonely travels and embrace the joy of shared experiences with MateTraveler.</p>
        </div>
      </div>
    </div>
  )
